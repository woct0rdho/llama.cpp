...
// Q5_K is the one type whose dense and routed decisions differ: its dequant is cheap enough to beat
// MMQ once the token tiles cover the weight, but the routed kernel wastes a 128-row tile on the few
