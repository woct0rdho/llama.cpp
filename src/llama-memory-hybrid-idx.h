...
public:
    ...
    // tail_idxs I32 [ratio-1, n_tokens/ns, ns] cells of the query's own incomplete block, -1 when absent
    // with tail_idxs the block bias is exact instead: -inf unless the whole block lies at or before the query
